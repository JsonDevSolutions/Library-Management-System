...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 id = "trial" class="page-title">Add New Staff</h4>
        </div>
    </div>
...
<form class="needs-validation" novalidate action="{{ route('borrowers-staff.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
    @csrf
    <div class="row">
        <div class="card">
            <div class="col-lg-12">
