    ...
    <div class="row">
        <div class="col-md-6 col-xxl-3">
            <div class="card">
                <div class="card-body">
                    <div class="row" >
                        <label  class="font-20 fw-bold text-danger" style="text-align-last: center;">Student Information</label>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select data-toggle="select2" title="category" onchange="GetStudentInfo(this.value)" name="borrower_id_number">
                            <option value="0">Select Borrower</option>
                            @foreach ($students as $student)
                                <option value="{{ $student->id_number }}">{{ $student->full_name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3" id="student">
                        <label for="simpleinput" class="form-label">Grade Level & Section</label>
                        <input type="text" id="grade_level_section" class="form-control" readonly="">
                    </div>
                </div>
            </div>
        </div> <!-- end col -->
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select data-toggle="select2" title="author" name="book_id" onchange="GetBookInfo(this.value)">
...
<script>
    ...
    // Get Data using Ajax Http Request
    // function tryAjax(Str) {
    //     let url ='/admin/borrowers-students/';
    //     url = url.concat(Str);
