...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 id = "trial" class="page-title">Edit Author</h4>
        </div>
    </div>
...
<div class="row">
    <div class="modal-content">
        <form class="needs-validation" novalidate action="{{ route('authors.update',$author->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <input type="text" value="{{ $author->name }}" class="form-control" name="name" required>
                </div>
            </div>
